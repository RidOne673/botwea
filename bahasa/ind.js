...
exports.rediregis = () => {
	return`*「 SUDAH TERDAFTAR 」*\n\n*Kamu sudah terdaftar di database OCTV-TECH ID*`
}
...
exports.bug = () => {
	return`*Masalah telah di laporkan ke owner OCTV-TECH ID, Laporan palsu atau main² tidak akan ditanggapi.*`
}
...
exports.limitend = (pushname, prefix) => {
	return`*Maaf ${pushname} limit hari ini habis*\n*Beli limit dengan menggunakan buylimit atau minta ke owner*`
}
