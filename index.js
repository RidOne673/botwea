...
const levelRole = getLevelingLevel(sender)
    ...
    // Tebak Gambar
        ...
        if (sim < tresshold && sim > 1 && sim > 1) return reply('Sedikit lagi..!')
        ...
        buttonMess = {
        contentText: "*Jawaban cak lontong adalah* : " + jawaban + "\n*Penjelasan*:" + penjelasani,
        footerText: `${setting.botname}`,
        buttons: buttons,
        headerType: 1
        }
    ...
    if (messagesC.includes('pass')) {
       buttons = [
        ...
        buttonMess = {
        contentText: `*Jawaban math adalah* : ${jawaban}`,
        footerText: `${setting.botname}`,
        buttons: buttons,
        headerType: 1
        }
    ...
    if (messagesC.includes('pass')) {
        ...
        buttonMess = {
        contentText: `*Jawaban asahotak adalah* : ${jawaban}`,
        footerText: `${setting.botname}`,
        buttons: buttons,
        headerType: 1
        }
    ...
    if (messagesC.includes('pass')) {
       buttons = [
        ...
        buttonMess = {
        contentText: `*Jawaban siapa aku adalah* : ${jawaban}`,
        footerText: `${setting.botname}`,
        buttons: buttons,
        headerType: 1
        }
    ...
    if (messagesC.includes('pass')) {
        ...
        buttonMess = {
        contentText: `*Jawaban susun kata adalah* : ${jawaban}`,
        footerText: `${setting.botname}`,
        buttons: buttons,
        headerType: 1
        }
    ...
    if (messagesC.includes('pass')) {
        ...
        buttonMess = {
        contentText: `*Jawaban tebak-tebakan adalah* : ${jawaban}`,
        footerText: `${setting.botname}`,
        buttons: buttons,
        headerType: 1
        }
    ...
    if (messagesC.includes('pass')) {
      reply(`*Jawaban captcha adalah* : ${jawaban}`)
        delete captcha[from]
    }
        }
    //KIMIA
        ...
        buttonMess = {
        contentText: `*Jawaban kimia adalah* : ${jawaban}`,
        footerText: `${setting.botname}`,
        buttons: buttons,
        headerType: 1
        }
...
if (isPower) return;
  ...
  caklontong[from] = jawaban.toLowerCase()
  penjelasan[from] = penjelasane.toLowerCase()
  s = jawaban.toLowerCase()
  s = s.replace (/a/g, "_ ")
  s = s.replace (/b/g, "_ ")
  s = s.replace (/c/g, "_ ")
  s = s.replace (/d/g, "_ ")
  ...
  jawaban = get_math.jawaban
  sak = `${ini_math} = `
  math2[from] = jawaban.toLowerCase()
